...
jarsigner -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore mushaf-key.jks ./platforms/android/build/outputs/apk/android-release-unsigned.apk mushaf -storepass muslim123@
~/Android/Sdk/build-tools/27.0.3/zipalign -v 4 ./platforms/android/build/outputs/apk/android-release-unsigned.apk ./platforms/android/build/outputs/apk/mushaf.apk
