...
describe('TafsirService', () => {
    ...
    it('Given http get is mocked to get tafsir content When findTafsirBySurahId is called Then it should return string content', (done) => {
        ...
        tafsirService.findTafsirBySurahId(1)
            .subscribe(content => {
    ...
    it('Given When findTafsirBySurahId is called with a value out of range Then it should throw RangeError', () => {
        tafsirService.findTafsirBySurahId(0)
            .subscribe(str => fail()
            , err => {
        ...
        tafsirService.findTafsirBySurahId(115)
            .subscribe(str => fail()
            , err => {
                console.info(err.message);
                expect(err instanceof RangeError).toBeTruthy();
